...
e1 = Checkbutton(window, text = "Just letters", variable = var1, onvalue=1, offvalue=0) # command=password
e1.grid(row = 1, column = 0, sticky = W)

e2 = Checkbutton(window, text = "Numbers and letters", variable = var2, onvalue=1, offvalue=0) # command=password
e2.grid(row = 2, column = 0, sticky = W)

e3 = Checkbutton(window, text = "Letters, numbers and special characters", variable = var3, onvalue=1, offvalue=0) # command=password
